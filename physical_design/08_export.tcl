...
#
#  Outputs: GDSII, Post-Route Netlist, DEF, SDF, SPEF
# ============================================================
...
if {[file exists $LAYER_MAP]} {
    ...
    write_stream ${OUTPUT_DIR}/risc_v.gds -mode ALL -units 2000
}
...
puts "INFO: Writing SDF for slow and fast corners..."
write_sdf -view view_slow ${OUTPUT_DIR}/risc_v_slow.sdf
write_sdf -view view_fast ${OUTPUT_DIR}/risc_v_fast.sdf
...
puts "   Layout:   ${OUTPUT_DIR}/risc_v.gds"
